...
function secondsToHMS(value) {
	return (Math.floor(value / 3600)).toLocaleString(undefined, {minimumIntegerDigits: 1}) + ':' 
		+ (Math.floor(value / 60) % 60).toLocaleString(undefined, {minimumIntegerDigits: 2}) + ':'
		+ (value % 60).toLocaleString(undefined, {minimumIntegerDigits: 2});
}
